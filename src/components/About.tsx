...
const About: React.FC = () => {
  ...
  return (
    <>
      ...
      <div>
        <p>I am an engineer with a B.S. in biomedical engineering and a minor in computer science from UVA. As a student, I was able to discover my interest in applying data science and computational modeling to biology and genetics through my courses and research projects. Combined with my appreciation of aesthetics, these experiences have allowed me to realize that I enjoy building intuitive interfaces and presenting complex data in digestible ways.</p>
